...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = bint2word(mulBint(sword2bint(src1), sword2bint(src2)), 63, 32));
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = bint2word(mulBint(sword2bint(src1),  word2bint(src2)), 63, 32));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = bint2word(mulBint( word2bint(src1),  word2bint(src2)), 63, 32));
  ...
  INSTPAT("0000001 ????? ????? 000 ????? 01110 11", mul    , R, R(rd) = SEXT(( int32_t)src1 * ( int32_t)src2, 32));
