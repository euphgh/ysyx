...
import macros.decode.DecodeUtils

object Mips32Instr extends DecodeUtils {
  override val allInstr = Seq(
    ...
    TLBP -> List(SRCType.noSRC, DSTType.noDST, ChiselFuType.MDU, MduType.TLBP, SpecialType.TLB),
    TLBR -> List(SRCType.noSRC, DSTType.noDST, ChiselFuType.MDU, MduType.TLBR, SpecialType.TLB),
    TLBWI -> List(SRCType.noSRC, DSTType.noDST, ChiselFuType.MDU, MduType.TLBWI, SpecialType.TLB),
    TLBWR -> List(SRCType.noSRC, DSTType.noDST, ChiselFuType.MDU, MduType.TLBWR, SpecialType.TLB),
